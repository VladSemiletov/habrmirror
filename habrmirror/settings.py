"""
Django settings for habrmirror project.
...
SECRET_KEY = 'django-insecure-9ne49i(9an2tj#5e2exqbm6746u_-$leysonnsu6qi6*v74)wt'
...
WSGI_APPLICATION = 'habrmirror.wsgi.application'
...
# Третий вариант, который рекомендовал Преподаватель
# DATABASES = {
#     'default': {
#         'ENGINE': 'django.db.backends.sqlite3',
